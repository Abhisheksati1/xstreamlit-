...
from nextpy.compiler import compiler, utils
...
def test_compile_stylesheets(tmp_path, mocker):
    ...
    mocker.patch("nextpy.compiler.compiler.Path.cwd", return_value=project)
...
def test_compile_stylesheets_exclude_tailwind(tmp_path, mocker):
    ...
    mocker.patch("nextpy.compiler.compiler.get_config", return_value=mock)
